...
import org.tensorflow.codelabs.Regression.EyeMouthRegression
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun runRegression(bitmap: Bitmap, text: String): Float {
        ...
        if ("eye" in text){
            tflite = Interpreter(eyeMouthReg.loadEyeModelFile(this))
        }
        else{
            tflite = Interpreter(eyeMouthReg.loadMouthModelFile(this))
        }
    ...
    private fun drawDetectionResult(
        ...
        detectionResults.forEach {
            ...
            var cropped = Bitmap.createBitmap(bitmap, box.left.toInt(), box.top.toInt(), box.width().toInt(), box.height().toInt())
            var output = runRegression(cropped, it.text)
